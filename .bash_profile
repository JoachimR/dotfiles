...
alias e4="cd ~/workspace/eee/4/ryter"
alias e5="cd ~/workspace/eee/5/ryter"
alias e6="cd ~/workspace/eee/6/ryter"
...
alias sss='git stash && git checkout main && git pull && git branch | grep -v -E "^\*?\s*main$" | xargs -r git branch -D ; pnpm install'
